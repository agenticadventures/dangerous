...
## Overview
A single-page browser app (plain HTML/CSS/JS, no build step) where users paint a world map and generate realistic climate biomes based on Earth-like rules. 
Deploys automatically to GitHub Pages on every push. Only push non-breaking changes.
